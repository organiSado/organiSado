...
/**
 * This is the model class for table "item_assigned".
 *
 * The followings are the available columns in table 'item_assigned':
 * @property string $item
 * @property integer $event
 * @property string $email
 * @property integer $quantity
 */
class ItemAssigned extends CActiveRecord
{
	/**
	 ...
	 * @return ItemAssigned the static model class
	 */
