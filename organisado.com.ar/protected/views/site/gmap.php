...
<div class="container marketing" align="left">
  <div class="content">
    <div class="row">
      	<h2>GMap</h2>
      	<input type="text" id='address' onkeyup="findAddressInEditorMap(this.value)">Mejorar con timer para no saturara de queries y hacer que el arrastrar el marker devuelva la direccion, e imprimir en el infoWindow la direccion
      	<br>
